...
Alternatively, you can enable `AngularJS` module in suite configuration file and run
...
<p>&nbsp;</p><div class="alert alert-warning">Module reference is taken from the source code. <a href="https://github.com/Codeception/module-angularjs/tree/master/src/Codeception/Module/AngularJS.php">Help us to improve documentation. Edit module reference</a></div>
